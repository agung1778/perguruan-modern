                ...
                <div class="flex items-start gap-4">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="mt-2 text-base font-bold text-slate-900 sm:text-lg">
                            ...
                            <?php echo e($agenda->location ?? 'Belum ditentukan'); ?>
            ...
            <div class="max-w-3xl">
                ...
                <div class="mt-7 text-sm leading-8 text-slate-600 sm:text-base">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agenda->description): ?>
                        ...
                        <?php echo nl2br(e($agenda->description)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/pages/agenda/show.blade.php ENDPATH**/ ?>