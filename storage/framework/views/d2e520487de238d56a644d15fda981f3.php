                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($website?->phone): ?>
                                    <a href="tel:<?php echo e($website->phone); ?>" class="mt-1 inline-block text-sm font-medium text-slate-500 transition hover:text-emerald-600 sm:text-base">
                        ...
                        <div class="flex gap-4">
                            ...
                            <div class="min-w-0">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($website?->email): ?>
                                    <a href="mailto:<?php echo e($website->email); ?>" class="mt-1 block break-all text-sm font-medium text-slate-500 transition hover:text-emerald-600 sm:text-base">
        ...
        <div class="lg:col-span-3">
            <div class="h-full overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                ...
                <div class="relative min-h-[380px] w-full bg-slate-100 sm:min-h-[450px]">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($website?->google_maps)): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/pages/contact.blade.php ENDPATH**/ ?>