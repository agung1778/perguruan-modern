...
>
    ...
    <div class="relative h-64 overflow-hidden bg-emerald-950">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->photo): ?>
            ...
            <img
                src="<?php echo e(Storage::url($teacher->photo)); ?>"
    ...
    <div class="p-5">
        ...
        <span class="text-xs font-bold uppercase tracking-wider text-emerald-600">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->type === 'staff'): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->position): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->type !== 'staff' && $teacher->subject): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($teacher->description || $teacher->bio): ?>

            <p class="mt-4 line-clamp-2 text-sm leading-6 text-slate-500">

                <?php echo e(Str::limit($teacher->description ?: $teacher->bio, 100)); ?>
...
</article><?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/partials/educator-card.blade.php ENDPATH**/ ?>