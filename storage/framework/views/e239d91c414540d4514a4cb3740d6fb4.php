    ...
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid items-center gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->welcome_message)): ?>
                ...
                <div class="mt-8 flex items-center gap-3 text-sm font-medium text-slate-500">
                    <span class="flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor" class="h-5 w-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75v4.5l3 1.5m6-1.5a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                        </svg>
                    </span>
                    <span>
            ...
            <div class="relative flex justify-center lg:justify-end">
                ...
                <div class="relative flex h-72 w-72 items-center justify-center rounded-[2rem] border border-slate-200 bg-white p-8 shadow-2xl shadow-emerald-900/10 sm:h-80 sm:w-80">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->logo)): ?>
                        <img src="<?php echo e(Storage::url($website->logo)); ?>" alt="<?php echo e($website?->site_name ?? 'Logo Perguruan'); ?>" loading="lazy" class="h-full w-full object-contain">
                    <?php else: ?>
                        <div class="flex h-full w-full flex-col items-center justify-center text-center">
                            <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor"class="h-8 w-8" >
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 21h18M5.25 21V9.75L12 5l6.75 4.75V21M9 21v-5.25h6V21"/>
                                </svg>
                            </div>
...
<?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/components/sections/welcome.blade.php ENDPATH**/ ?>