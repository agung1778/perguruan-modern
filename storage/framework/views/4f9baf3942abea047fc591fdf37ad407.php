...
<section class="bg-slate-50 py-14 sm:py-20 lg:py-24">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 sm:mb-12 sm:rounded-3xl sm:p-6">
            ...
            <form
                action="<?php echo e(route('ppdb.index')); ?>"
                method="GET"
            ...
            >
                ...
                <div class="w-full flex-1">
                    ...
                    <select
                        name="unit"
                        id="unit"
                        class="w-full rounded-xl border-slate-300 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm outline-none transition focus:border-emerald-600 focus:ring-emerald-600"
                    >
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <option
                                ...
                                <?php if(request('unit') == $unit->id): echo 'selected'; endif; ?>
                            >
                ...
                <div class="flex w-full gap-3 lg:w-auto">
                    ...
                    <button
                        type="submit"
                        class="flex-1 rounded-xl bg-emerald-700 px-6 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 lg:flex-none"
                    >
                        Filter
                    </button>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->filled('unit')): ?>

                        <a
                            href="<?php echo e(route('ppdb.index')); ?>"
                            class="flex-1 rounded-xl border border-slate-300 bg-white px-6 py-3 text-center text-sm font-bold text-slate-700 transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-slate-300 lg:flex-none"
                        >
                            Reset
                        </a>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdbs->count()): ?>

            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ppdbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ppdb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    >
                            ...
                            <div class="relative flex items-start justify-between gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <span class="block truncate text-xs font-semibold uppercase tracking-wide text-emerald-300">
                                        <?php echo e($ppdb->educationUnit?->name ?? 'Perguruan Amaliah'); ?>

                                    </span>

                                    <h2 class="mt-2 line-clamp-2 text-xl font-bold leading-tight sm:text-2xl">
                                        <?php echo e($ppdb->title); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->status === 'open'): ?>
                                ...
                                <?php elseif($ppdb->status === 'upcoming'): ?>
                        ...
                        <div class="flex flex-1 flex-col p-6 sm:p-7">
                            ...
                            <div class="space-y-5">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->registration_start || $ppdb->registration_end): ?>
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="mt-1 text-sm font-semibold leading-6 text-slate-800">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->registration_start): ?>

                                                    <?php echo e($ppdb->registration_start->translatedFormat('d F Y')); ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->registration_end): ?>

                                                    <?php echo e($ppdb->registration_end->translatedFormat('d F Y')); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->description): ?>

                                <div class="mt-6 border-t border-slate-100 pt-6">

                                    <p class="line-clamp-3 text-sm leading-7 text-slate-600">
                                        <?php echo e(strip_tags($ppdb->description)); ?>
                            ...
                            <div class="mt-auto flex flex-col gap-3 pt-7 sm:flex-row">
                                ...
                                <a
                                    href="<?php echo e(route('ppdb.show', $ppdb)); ?>"
                                    class="flex-1 rounded-xl bg-emerald-700 px-5 py-3 text-center text-sm font-bold text-white transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                                >
                                    Lihat Detail
                                </a>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ppdb->status === 'open' && $ppdb->registration_url): ?>

                                    <a
                                        href="<?php echo e($ppdb->registration_url); ?>"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        class="flex-1 rounded-xl bg-amber-500 px-5 py-3 text-center text-sm font-bold text-slate-950 transition hover:bg-amber-400 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2"
                                    >
                                        Daftar Sekarang
                                    </a>
                ...
                <div class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 text-emerald-700">
                    ...
                    >
                        ...
                        <path
                            ...
                            stroke-linejoin="round"
                            stroke-width="2"
                            d="M12 14l6.16-3.42A12.04 12.04 0 0118 16.5c-1.7 1.1-3.75 1.75-6 1.75s-4.3-.65-6-1.75a12.04 12.04 0 01-.16-5.92L12 14z"
                        />
                    </svg>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/pages/ppdb/index.blade.php ENDPATH**/ ?>