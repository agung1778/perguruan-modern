    ...
    <div class="flex h-20 items-center justify-between">
            ...
            <div class="relative flex h-12 w-12 shrink-0 items-center justify-center sm:h-14 sm:w-14">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($website?->logo): ?>
                    ...
                    <img
                        ...
                        alt="<?php echo e($website->school_name); ?>"
        ...
        >
            ...
            <a
                ...
                class="group relative rounded-xl px-4 py-3 text-sm font-semibold transition duration-200
                <?php echo e(request()->routeIs('units.*')
                    ? 'bg-emerald-50 text-emerald-700'
                    : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-700'); ?>"
            >
                Unit Pendidikan
            ...
            <a
                ...
                class="group relative rounded-xl px-4 py-3 text-sm font-semibold transition duration-200
                <?php echo e(request()->routeIs('news.*')
                    ? 'bg-emerald-50 text-emerald-700'
                    : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-700'); ?>"
            >
                Berita
            ...
            <a
                ...
                class="group relative rounded-xl px-4 py-3 text-sm font-semibold transition duration-200
                <?php echo e(request()->routeIs('agenda.*')
                    ? 'bg-emerald-50 text-emerald-700'
                    : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-700'); ?>"
            >
                Agenda
            ...
            <a
                ...
                class="group relative rounded-xl px-4 py-3 text-sm font-semibold transition duration-200
                <?php echo e(request()->routeIs('gallery.*')
                    ? 'bg-emerald-50 text-emerald-700'
                    : 'text-slate-600 hover:bg-emerald-50 hover:text-emerald-700'); ?>"
            >
                Galeri
