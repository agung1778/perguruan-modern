        ...
        <div class="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->logo)): ?>
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/10 p-2 shadow-lg backdrop-blur-sm">
                            <img src="<?php echo e(Storage::url($website->logo)); ?>" class="h-full w-full object-contain" alt="<?php echo e($website?->school_name ?? 'Logo Perguruan'); ?>">
                        </div>
                    <?php else: ?>
            ...
            <div>
                ...
                <ul class="mt-7 space-y-4 text-sm">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-2 text-emerald-100/60 transition hover:text-emerald-300">
                            <span class="h-1 w-0 rounded-full bg-emerald-500 transition-all duration-300 group-hover:w-3"></span>
                            Beranda
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('about')); ?>" class="group flex items-center gap-2 text-emerald-100/60 transition hover:text-emerald-300" >
                            <span class="h-1 w-0 rounded-full bg-emerald-500 transition-all duration-300 group-hover:w-3"></span>
                            Tentang Kami
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('units.index')); ?>" class="group flex items-center gap-2 text-emerald-100/60 transition hover:text-emerald-300" >
                            <span class="h-1 w-0 rounded-full bg-emerald-500 transition-all duration-300 group-hover:w-3"></span>
                            Unit Pendidikan
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('news.index')); ?>" class="group flex items-center gap-2 text-emerald-100/60 transition hover:text-emerald-300">
                            <span class="h-1 w-0 rounded-full bg-emerald-500 transition-all duration-300 group-hover:w-3"></span>
                            Berita
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('gallery.index')); ?>" class="group flex items-center gap-2 text-emerald-100/60 transition hover:text-emerald-300">
                            <span class="h-1 w-0 rounded-full bg-emerald-500 transition-all duration-300 group-hover:w-3"></span>
                            Galeri
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('ppdb.index')); ?>" class="group flex items-center gap-2 font-medium text-emerald-300 transition hover:text-emerald-200">
                ...
                <div class="mt-7 space-y-6 text-sm">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->phone)): ?>
                        <div class="flex items-center gap-4">
                            ...
                            <a href="tel:<?php echo e($website->phone); ?>" class="text-emerald-100/60 transition hover:text-emerald-300">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->email)): ?>
                        <div class="flex items-center gap-4">
                            ...
                            <a href="mailto:<?php echo e($website->email); ?>" class="break-all text-emerald-100/60 transition hover:text-emerald-300">
            ...
            <div>
                ...
                <div class="mt-6 flex flex-wrap gap-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->facebook)): ?>
                        <a href="<?php echo e($website->facebook); ?>" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="flex h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-semibold text-emerald-100/70 transition hover:border-emerald-400/30 hover:bg-emerald-600 hover:text-white" >
                            Facebook
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->instagram)): ?>
                        <a href="<?php echo e($website->instagram); ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="flex h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-semibold text-emerald-100/70 transition hover:border-emerald-400/30 hover:bg-emerald-600 hover:text-white">
                            Instagram
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($website?->youtube)): ?>
                        <a href="<?php echo e($website->youtube); ?>" target="_blank" rel="noopener noreferrer" aria-label="YouTube" class="flex h-11 items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 text-sm font-semibold text-emerald-100/70 transition hover:border-emerald-400/30 hover:bg-emerald-600 hover:text-white">
                            YouTube
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
