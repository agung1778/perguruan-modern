...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($units->count()): ?>

    <div
        x-data="{
            current: 0,
            total: <?php echo e($units->count()); ?>,
            visible: 3,
            timer: null,
    ...
    >
                        ...
                        <article class="group flex h-full flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
                            ...
                            <div class="relative h-56 overflow-hidden bg-emerald-950 sm:h-60">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->photo): ?>
                                    <img src="<?php echo e(Storage::url($unit->photo)); ?>" alt="<?php echo e($unit->name); ?>" loading="lazy" decoding="async" class="h-full w-full object-cover transition duration-500 ease-out group-hover:scale-105">
                            ...
                            <div class="relative flex flex-1 flex-col px-5 pb-6 sm:px-7 sm:pb-7">
                                ...
                                <div class="-mt-12 flex justify-center">
                                    <div class="flex h-24 w-24 items-center justify-center overflow-hidden rounded-2xl border-4 border-white bg-white p-3 shadow-lg sm:h-28 sm:w-28">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->logo): ?>
                                            <img src="<?php echo e(Storage::url($unit->logo)); ?>" alt="Logo <?php echo e($unit->name); ?>"loading="lazy" decoding="async" class="h-full w-full object-contain">
                                        <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unitAcademicYear): ?>
                                    <div class="mt-5 flex items-center justify-center gap-2 text-xs font-semibold text-emerald-700">
                                        ...
                                        <span>
                                            Tahun Ajaran <?php echo e($unitAcademicYear); ?>
                                ...
                                <div class="mt-5 grid grid-cols-2 gap-3">
                                    ...
                                    <div class="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4 text-center">
                                        <div class="text-2xl font-extrabold text-emerald-700">
                                            <?php echo e(number_format($unitStudentCount)); ?>
                                ...
                                <div class="mt-6 flex flex-1 items-end">
                                    <a href="<?php echo e(route('units.show', $unit)); ?>" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-3 text-sm font-bold text-white transition duration-200 hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                                        <span>
                                            Lihat Detail
                                        </span>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($units->count() > 1): ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($units->count()): ?>
    <div class="mt-10 text-center">
        <a href="<?php echo e(route('units.index')); ?>" class="inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-200 bg-white px-6 py-3.5 text-sm font-bold text-emerald-700 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
            <span>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/components/sections/units.blade.php ENDPATH**/ ?>