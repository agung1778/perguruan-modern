...
<section class="relative overflow-hidden bg-emerald-950">
    ...
    <div class="relative mx-auto max-w-7xl px-5 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <nav class="mb-8 flex flex-wrap items-center gap-2 text-sm text-emerald-100/70" aria-label="Breadcrumb">
            <a href="<?php echo e(url('/')); ?>" class="transition hover:text-white">
                Beranda
            </a>
            <span>/</span>
            <a href="<?php echo e(route('units.index')); ?>" class="transition hover:text-white">
                Unit Pendidikan
            </a>
            <span>/</span>
    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            ...
            <div class="lg:col-span-3">
                <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->photo): ?>
                        <img src="<?php echo e(Storage::url($unit->photo)); ?>" alt="<?php echo e($unit->name); ?>" loading="lazy" decoding="async"class="h-[280px] w-full object-cover sm:h-[420px] lg:h-[520px]">
                    <?php else: ?>
                ...
                <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 lg:p-10">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->website): ?>
                        <div class="mt-8 border-t border-slate-100 pt-8">
                            ...
                            <a href="<?php echo e($unit->website); ?>" target="_blank" rel="noopener noreferrer" class="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-3.5 text-sm font-semibold text-white transition hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                                <span>
                    ...
                    <a href="<?php echo e(route('units.index')); ?>" class="mt-4 flex w-full items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-3.5 text-sm font-semibold text-slate-700 transition hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700">
        ...
        <div class="mt-16 border-t border-slate-200 pt-16">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($academicYears && $academicYears->count()): ?>
                <form method="GET" action="<?php echo e(route('units.show', $unit)); ?>" class="mt-6">
