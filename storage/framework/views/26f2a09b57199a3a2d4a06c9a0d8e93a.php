    ...
    <div class="mt-12 border-t border-slate-200 pt-12 sm:mt-16 sm:pt-16">
                    ...
                    <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-700">
                        ...
                        >
                            <path
                                ...
                                M15 19.128v-.003c0-.083-.002-.166-.005-.248
                                A6.72 6.72 0 0 0 9.75 12.75
                                a6.72 6.72 0 0 0-5.245 6.127
                                c-.003.082-.005.165-.005.248v.003
                                m10.5 0a9.38 9.38 0 0 1-3.75.75
                                9.38 9.38 0 0 1-3.75-.75
                                m7.5 0a24.255 24.255 0 0 1-7.5 0
                                M12 12.75a3.375 3.375 0 1 0 0-6.75
                                3.375 3.375 0 0 0 0 6.75Z"
                            />
                        </svg>
                    ...
                    <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-green-50 text-green-700">
                        ...
                        >
                            <path
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                d="M18 18.72a9.094 9.094 0 0 0 3.75-.952
                                4.125 4.125 0 0 0-7.533-2.493
                                M18 18.72v-.003c0-.083-.002-.166-.005-.248
                                A6.72 6.72 0 0 0 12.75 12.75
                                a6.72 6.72 0 0 0-5.245 6.127
                                c-.003.082-.005.165-.005.248v.003
                                m10.5 0a24.255 24.255 0 0 1-7.5 0
                                M15.75 6.375a3.375 3.375 0 1 1-6.75 0
                                3.375 3.375 0 0 1 6.75 0Zm6.75 3.375
                                a2.625 2.625 0 1 1-5.25 0
                                2.625 2.625 0 0 1 5.25 0ZM3.75 9.75
                                a2.625 2.625 0 1 0 5.25 0
                                2.625 2.625 0 0 0-5.25 0Z"
                            />
                        </svg>
        ...
        <div class="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->students && $unit->students->count()): ?>

                    <div class="divide-y divide-slate-100">

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $unit->students
                                ->groupBy('generation')
                                ->sortKeysDesc(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $generation => $students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <div class="flex items-center justify-between gap-4 px-6 py-5">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-slate-800">
                                        Angkatan <?php echo e($generation ?: 'Tidak Diketahui'); ?>
                                ...
                                <span class="shrink-0 rounded-full bg-emerald-50 px-3 py-1.5 text-sm font-bold text-emerald-700">
                                    <?php echo e(number_format($students->count())); ?> Siswa
                                </span>
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unit->teachers && $unit->teachers->count()): ?>

                    <div class="divide-y divide-slate-100">

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $unit->teachers
                                ->groupBy('status'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $teachers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <div class="flex items-center justify-between gap-4 px-6 py-5">
                                ...
                                <span class="shrink-0 rounded-full bg-green-50 px-3 py-1.5 text-sm font-bold text-green-700">
                                    <?php echo e(number_format($teachers->count())); ?> Guru
                                </span>
