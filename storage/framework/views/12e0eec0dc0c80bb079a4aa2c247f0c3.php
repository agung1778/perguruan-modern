        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            >
                ...
                <div class="relative flex flex-1 flex-col px-5 pb-7 sm:px-7">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studentStats && $studentStats->total > 0): ?>
                        ...
                        <div class="mt-6">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($studentStats->academic_year): ?>
                                ...
                                <div class="mb-4 flex items-center justify-center gap-2 text-xs font-semibold text-emerald-600">
                                    ...
                                    <span>
                                        Tahun Ajaran <?php echo e($studentStats->academic_year); ?>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-4 text-center">
                                    ...
                                    <div class="text-2xl font-bold text-emerald-700">
                                        <?php echo e(number_format($studentStats->total)); ?>
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3">
                                ...
                                <div class="rounded-xl border border-blue-100 bg-blue-50 p-3 text-center">
                                    ...
                                    <div class="text-lg font-bold text-blue-700">
                                        <?php echo e(number_format($studentStats->male)); ?>
                                ...
                                <div class="rounded-xl border border-pink-100 bg-pink-50 p-3 text-center">
                                    ...
                                    <div class="text-lg font-bold text-pink-700">
                                        <?php echo e(number_format($studentStats->female)); ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="mt-6 rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-5 text-center">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestAcademicYear): ?>

                                <p class="mt-1 text-xs text-slate-400">
                                    Tahun Ajaran <?php echo e($latestAcademicYear); ?>
