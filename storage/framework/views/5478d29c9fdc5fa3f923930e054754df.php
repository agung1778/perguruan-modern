...
<section class="relative overflow-hidden bg-emerald-950 py-24 text-white sm:py-28">
    ...
    <div class="pointer-events-none absolute left-1/2 top-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/5 blur-3xl"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid items-center gap-14 lg:grid-cols-2 lg:gap-20">
            ...
            <div>
                ...
                <div class="inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-4 py-2 text-sm font-semibold uppercase tracking-wider text-emerald-300">
                ...
                <h2 class="mt-6 text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl">
                ...
                <p class="mt-7 max-w-xl text-base leading-8 text-emerald-100/70 sm:text-lg">

                    Silakan hubungi kami untuk mendapatkan informasi lebih lanjut
                    mengenai <?php echo e($website?->school_name ?? 'Perguruan Amaliah'); ?>,
                ...
                <div class="mt-10 space-y-4">
                    ...
                    <div class="group flex items-start gap-5 rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition-all duration-300 hover:border-emerald-400/30 hover:bg-white/10">
                            ...
                            <div class="flex h-[420px] items-center justify-center bg-emerald-900">
                                ...
                                <div class="px-6 text-center">
                                    ...
                                    <p class="mx-auto mt-2 max-w-sm text-sm leading-7 text-emerald-100/50">
                                        ...
                                        Silakan tambahkan lokasi perguruan melalui pengaturan website.
...
<?php /**PATH C:\Users\PC PPLG 01\perguruan-modern\resources\views/components/sections/contact.blade.php ENDPATH**/ ?>