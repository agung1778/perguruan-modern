    ...
    <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="mx-auto mt-6 max-w-2xl text-base leading-8 text-slate-600 sm:text-lg">
                Informasi kegiatan dan agenda terbaru yang akan dilaksanakan oleh
                                    ...
                                    <div class="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600">
                                        ...
                                        >
                                            <path
                                                ...
                                                d="M6.75 3v3M17.25 3v3M3.75 9.75h16.5M5.25 5.25h13.5a2.25 2.25 0 0 1 2.25 2.25v11.25a2.25 2.25 0 0 1 2.25 2.25V18.75a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25Z"
                                            />
                                        </svg>
                                ...
                                <div class="min-w-0">
                                    ...
                                    @if(filled($agenda->description))
                                        ...
                                        <p class="mt-4 max-w-3xl text-sm leading-7 text-slate-600">
                                            {{ \Illuminate\Support\Str::limit(strip_tags($agenda->description), 150) }}
                                        </p>
