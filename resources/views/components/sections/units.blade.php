...
<section class="relative overflow-hidden bg-slate-50 py-16 sm:py-20 lg:py-24">
    ...
    ====================================================== --}}
    <div class="pointer-events-none absolute -left-40 top-20 h-72 w-72 rounded-full bg-emerald-100/50 blur-3xl"></div>
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto max-w-3xl text-center">
            ...
            <div class="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-xs font-semibold uppercase tracking-wider text-emerald-700 sm:text-sm">
            ...
            <p class="mx-auto mt-5 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base sm:leading-8 lg:text-lg">
                Kenali berbagai unit pendidikan yang berada di bawah
        ...
        @if($units->count())
            ...
            <div
                x-data="{
                    ...
                    startAutoSlide() {
                        ...
                        if (this.total <= this.visible || this.paused) {
                            return;
                        }
                ...
                class="relative mt-10 sm:mt-12 lg:mt-16"
                @mouseenter="pause()"
                @mouseleave="resume()"
            ...
            >
                ...
                <div class="overflow-hidden rounded-3xl">
                    ...
                    ================================================== --}}
                    <div
                        class="flex -mx-2.5 transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] sm:-mx-3"
                    ...
                    >
                        ...
                        @foreach($units as $unit)
                            ...
                            ================================================== --}}
                            <div
                                class="min-w-0 shrink-0 px-2.5 sm:px-3"
                            ...
                            >
                                ...
                                {{-- =================================================
                                    CARD
                                ================================================== --}}
                                <article class="group flex h-full min-h-[620px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:rounded-3xl">

                                    {{-- =================================================
                                        IMAGE
                                    ================================================== --}}
                                    <div class="relative h-48 shrink-0 overflow-hidden bg-emerald-950 sm:h-56 lg:h-60">
                                        ...
                                        @else
                                            ...
                                            <div class="flex h-full items-center justify-center bg-gradient-to-br from-emerald-800 via-emerald-900 to-slate-950">
                                                ...
                                                <svg
                                                    ...
                                                    stroke-width="1.5"
                                                    stroke="currentColor"
                                                    class="h-14 w-14 text-emerald-300/40 sm:h-16 sm:w-16"
                                                >
                                                    <path
                                        ...
                                        <div class="absolute inset-x-0 bottom-0 p-4 sm:p-5">
                                            ...
                                            <span class="inline-flex rounded-full border border-white/20 bg-black/20 px-3 py-1 text-xs font-semibold text-white backdrop-blur-md">
                                    ...
                                    {{-- =================================================
                                        CARD CONTENT
                                    ================================================== --}}
                                    <div class="relative flex flex-1 flex-col px-5 pb-5 sm:px-6 sm:pb-6 lg:px-7 lg:pb-7">
                                        ...
                                        <div class="-mt-10 flex justify-center sm:-mt-12">
                                            ...
                                            <div class="flex h-20 w-20 items-center justify-center overflow-hidden rounded-2xl border-4 border-white bg-white p-2.5 shadow-lg sm:h-24 sm:w-24 sm:p-3 lg:h-28 lg:w-28">
                                                ...
                                                @else
                                                    ...
                                                    <div class="flex h-full w-full items-center justify-center rounded-xl bg-emerald-50">
                                                        ...
                                                        <svg
                                                            ...
                                                            stroke-width="1.5"
                                                            stroke="currentColor"
                                                            class="h-8 w-8 text-emerald-600 sm:h-10 sm:w-10"
                                                        >
                                                            <path
                                                                stroke-linecap="round"
                                                                stroke-linejoin="round"
                                        ...
                                        <div class="mt-5 text-center sm:mt-6">
                                            ...
                                            <h3 class="line-clamp-2 text-lg font-bold tracking-tight text-slate-900 sm:text-xl lg:text-2xl">
                                                {{ $unit->name }}
                                            </h3>
                                        ...
                                        {{-- =================================================
                                            DESCRIPTION
                                        ================================================== --}}
                                        <div class="mt-4 min-h-[84px] text-center">
                                        ...
                                        @if($unitAcademicYear)
                                            ...
                                            <div class="mt-4 flex items-center justify-center gap-2 text-xs font-semibold text-emerald-700 sm:mt-5">
                                        ...
                                        <div class="mt-5 grid grid-cols-2 gap-3">
                                            ...
                                            {{-- TOTAL SISWA --}}
                                            <div class="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-3 text-center sm:p-4">

                                                <div class="text-xl font-extrabold text-emerald-700 sm:text-2xl">
                                            ...
                                            {{-- TOTAL GURU --}}
                                            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-3 text-center sm:p-4">
                                        ...
                                        <div class="mt-6">
                                            ...
                                            <a
                                                ...
                                                class="group/button inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-700 px-5 py-3 text-sm font-bold text-white shadow-sm transition-all duration-200 hover:bg-emerald-800 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                                            >
                ...
                @if($units->count() > 1)
                    ...
                    <div class="mt-7 flex items-center justify-center gap-3 sm:mt-8 sm:gap-4">
                        ...
                        <button
                            ...
                            class="group flex h-10 w-10 items-center justify-center rounded-full border border-emerald-200 bg-white text-emerald-700 shadow-sm transition duration-300 hover:border-emerald-600 hover:bg-emerald-700 hover:text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 sm:h-11 sm:w-11"
                        >
                        ...
                        {{-- INDICATORS --}}
                        <div class="flex max-w-[180px] items-center justify-center gap-1.5 overflow-hidden sm:max-w-none sm:gap-2">
                            ...
                            <template x-for="index in Math.max(1, total - visible + 1)" :key="index">
                                ...
                                <button
                                    ...
                                    :class="current === index - 1
                                        ? 'w-7 bg-emerald-600 sm:w-8'
                                        : 'w-2 bg-emerald-200 hover:bg-emerald-400'"
                                    class="h-2 rounded-full transition-all duration-300"
                                    :aria-label="`Buka slide ${index}`"
                                ></button>
        ...
        @else
            ...
            <div class="mt-10 sm:mt-12">
                ...
                <div class="rounded-2xl border border-dashed border-slate-300 bg-white px-5 py-16 text-center shadow-sm sm:rounded-3xl sm:px-6 sm:py-20">
        ...
        @if($units->count())
            ...
            <div class="mt-8 text-center sm:mt-10">
                ...
                <a
                    ...
                    class="inline-flex items-center justify-center gap-2 rounded-xl border border-emerald-200 bg-white px-5 py-3 text-sm font-bold text-emerald-700 shadow-sm transition hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 sm:px-6 sm:py-3.5"
                >
