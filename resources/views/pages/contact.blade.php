                    ...
                    <div class="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-700">
                        ...
                        >
                            <path
                                ...
                                d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25H4.5a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5H4.5a2.25 2.25 0 0 0-2.25 2.25m19.5 0-8.69 5.794a1.125 1.125 0 0 1-1.247 0L2.25 6.75"
                            />
                        </svg>
                            ...
                            <div>
                                ...
                                @if($website?->phone)
                                    ...
                                    <a
                                        ...
                                        class="mt-1 inline-block text-sm font-medium text-slate-500 transition hover:text-emerald-600 sm:text-base"
                                    >
                                        {{ $website->phone }}
                                    </a>
                            ...
                            <div class="min-w-0">
                                ...
                                @if($website?->email)
                                    ...
                                    <a
                                        ...
                                        class="mt-1 block break-all text-sm font-medium text-slate-500 transition hover:text-emerald-600 sm:text-base"
                                    >
                                        {{ $website->email }}
                                    </a>
