                ...
                <div class="grid md:grid-cols-2 gap-8">
                    @foreach($news as $item)
                        <article class="bg-white rounded-3xl shadow overflow-hidden">
                            <img src="{{ Storage::url($item->thumbnail) }}" class="w-full h-56 object-cover">
                                <div class="p-7">
                                    ...
                                    <a href="{{ route('news.show', ['news' => $news->slug]) }}" class="inline-block mt-6 text-blue-900 font-semibold">
                                        Baca Selengkapnya →
                                    </a>
                                </div>
                        </article>
            ...
            <div>
                <div class="bg-white rounded-3xl p-8 shadow">
                    ...
                    <ul class="mt-6 space-y-3">
                        ...
                        <li>
                            <a href="#" class="text-slate-600 hover:text-blue-900">
                                {{ $category->name }}
                            </a>
                        </li>
                        @endforeach
